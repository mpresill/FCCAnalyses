...
inputDir_path = '/ceph/awiedl/FCCee/HiggsCP/ecm240/ktN-tag/stage2_241202_cut/'
output = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm240/BDT/stage3/ktN-tag/submission/' ##output directory of submission files, needs to be different to have unique submission files
outputDir_path = '/ceph/awiedl/FCCee/HiggsCP/ecm240/ktN-tag/stage3_250130/' ##output directory of stage2 samples
localDir_path = '/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/ecm240/BDT/stage3/ktN-tag/'
...
for cat in CAT:
    for sub in SUBDIR:
        ...
        create_subjob_script(localDir_path, sourceDir, inputDir, cat, sub, output, outputDir, Filename)
