...
inputDir = "/ceph/awiedl/FCCee/HiggsCP/R5-tag/stage2_241025_BDT/NuNu/HH/"

#Optional: output directory, default is local running directory
outputDir   = "/ceph/awiedl/FCCee/HiggsCP/stage3_CNN/" 
...
ROOT.gInterpreter.ProcessLine('''using namespace TMVA::Experimental;

                                RSofieReader model("/work/awiedl/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/CNN/models/model_NuNuHH.onnx");

                                computeModel = Compute<33, float>(model);''') #needs to be passed the number of variables
...
class RDFanalysis():
    def analysers(df):
        df2 = (df
                ...
                .Define("CNN_pred", ROOT.computeModel, ["RecoEmiss_pz",
                                                        "RecoEmiss_pt",
                                                        "RecoEmiss_p",
                                                        "RecoEmiss_e",
                                                        "fRecoEmiss_costheta",
                ...
                .Define("CNN_score",        "CNN_pred.at(0)")
        )
        return df2
