...
output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/BDT/outputs_new/output_plot.txt"
...
# Save the figure
fig.savefig("/web/sgiappic/public_html/Higgs_xsec/BDT_v2/ROC_new/BDT_ROC.pdf")
