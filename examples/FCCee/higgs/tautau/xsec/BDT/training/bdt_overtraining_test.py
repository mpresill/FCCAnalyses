...
DIRECTORY = {
    'NuNu':"/ceph/awiedl/FCCee/HiggsCP/stage2_v2_cut/",
    'QQ':"/ceph/awiedl/FCCee/HiggsCP/stage2_v2_cut/",
    }
...
output_file = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/BDT/outputs_new/output_overtraining.txt"

modelDir = "/ceph/sgiappic/FCCAnalyses/examples/FCCee/higgs/tautau/xsec/BDT/models_new/"
...
for cat in CAT:
    for sub in SUBDIR:
        ...
        bdt = joblib.load(f"{modelDir}/xgb_bdt_{cat}{sub}.joblib")
        ...
        plt.grid()
        plt.tight_layout()
        plt.savefig("/web/sgiappic/public_html/Higgs_xsec/BDT_v2/ROC_new/"+cat+sub+"_overtrain.pdf")
